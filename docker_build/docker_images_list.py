...
STAGE_ONE_IMAGES = {
    ...
    'RustBase1680': ('mkbase_rust', 'rust:1.67.1', 'base'),
    'RustBase1680Alpine': ('mkbase_rust_alpine', 'rust:1.67.1-alpine', 'base'),
    'RustBase1680Debian': ('mkbase_rust_debian', 'rust:1.67.1', 'base'),
}
