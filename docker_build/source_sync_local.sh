...
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/*.rs ../docker/core/mkmetadata/src/.
...
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media.rs ../docker/core/mkmetadata/src/.
...
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_person.rs ../docker/core/mktmdbnetfetchupdate/src/.
...
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_cron.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_game_servers.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_library.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_network_share.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_notification.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_option_status.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_postgresql.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_search.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_sync.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_activity.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_queue.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_profile.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_version.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_version_schema.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_adult.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_anime.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_book.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_game.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_game_system.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_game_servers.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_home_media.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_images.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_iradio.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_movie.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_music.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_music_video.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_remote.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_sports.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_tv.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_adult.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_anime.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_book.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_collection.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_download_queue.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_game.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_game_system.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_image.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_movie.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_music.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_music_video.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_person.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_review.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_sports.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_tv.rs ../docker/core/mkwebrocket/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_tv_live.rs ../docker/core/mkwebrocket/src/.
...
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_cron.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_game_servers.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_library.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_network_share.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_notification.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_option_status.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_postgresql.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_search.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_sync.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_activity.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_queue.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_user_profile.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_version.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_version_schema.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_adult.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_anime.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_book.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_game.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_game_system.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/mk_lib_database_game_servers.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_home_media.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_images.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_iradio.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_movie.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_music.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_music_video.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_remote.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_sports.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/media/mk_lib_database_media_tv.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_adult.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_anime.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_book.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_collection.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_download_queue.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_game.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_game_system.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_image.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_movie.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_music.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_music_video.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_person.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_review.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_sports.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_tv.rs ../docker/core/mkwebaxum/src/.
\cp -f --remove-destination ../src/mk_lib_database/src/metadata/mk_lib_database_metadata_tv_live.rs ../docker/core/mkwebaxum/src/.
