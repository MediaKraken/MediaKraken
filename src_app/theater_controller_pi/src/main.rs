...
fn main() -> Result<(), Box<dyn Error>> {
    // load images
    let bytes_image_rectangle = include_bytes!("../../../docker/core/mkwebaxum/static/image/rectangles_black.png");
    let bytes_image_new = include_bytes!("../../../docker/core/mkwebaxum/static/image/new.png");
    let bytes_image_movie_ticket = include_bytes!("../../../docker/core/mkwebaxum/static/image/movie_ticket.png");
    let bytes_image_television = include_bytes!("../../../docker/core/mkwebaxum/static/image/television.png");
    let bytes_image_vid_game = include_bytes!("../../../docker/core/mkwebaxum/static/image/vid_game.png");
    let bytes_image_theater = include_bytes!("../../../docker/core/mkwebaxum/static/image/theater.png");
    let bytes_image_headphone = include_bytes!("../../../docker/core/mkwebaxum/static/image/headphone.png");
    let bytes_image_television_live = include_bytes!("../../../docker/core/mkwebaxum/static/image/television_live.png");
    let bytes_image_vid_camera = include_bytes!("../../../docker/core/mkwebaxum/static/image/vid_camera.png");
    let bytes_image_earth = include_bytes!("../../../docker/core/mkwebaxum/static/image/earth.png");
    let bytes_image_listening_music_video_clip_with_auricular = include_bytes!("../../../docker/core/mkwebaxum/static/image/listening-music-video-clip-with-auricular.png");
    ...
    let bytes_image_settings = include_bytes!("../../../docker/core/mkwebaxum/static/image/settings.png");
    ...
    let mut button_in_progress = Button::new(0, 0, 133, 96, None);
    ...
    let mut button_demo = Button::new(133, 0, 532, 384, None);
    ...
    let mut button_music = Button::new(133, 384, 133, 96, None);
    let mut image = fltk::image::PngImage::from_data(bytes_image_headphone)?;
    image.scale(133, 96, true, true);
    button_music.set_image(Some(image));
    let mut button_live_tv = Button::new(266, 384, 133, 96, None);
    let mut image =
    fltk::image::PngImage::from_data(bytes_image_television_live)?;
    image.scale(133, 96, true, true);
    button_live_tv.set_image(Some(image));
    let mut button_home_video = Button::new(399, 384, 133, 96, None);
    let mut image = fltk::image::PngImage::from_data(bytes_image_vid_camera)?;
    image.scale(133, 96, true, true);
    button_home_video.set_image(Some(image));
    let mut button_internet = Button::new(532, 384, 133, 96, None);
    ...
    let mut button_music_video = Button::new(666, 0, 133, 96, None);
    ...
    let mut button_settings_back = Button::new(666, 384, 133, 96, None);
