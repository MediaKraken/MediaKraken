$(function(){
    $('#the-movie-node').contextMenu({
        ...
        $.ajax({
                url: '/user/user_media_movie_status/' + $(this).attr('data-id') + '/' + key,
                type: 'POST',
...
$(function(){
    $('#the-movie-metadata-node').contextMenu({
        ...
        callback: function(key, options) {
            var m = "clicked: " + key + " on " + $(this).attr('data-id');
        $.ajax({
                url: '/user/user_metadata_movie_status/' + $(this).attr('data-id') + '/' + key,
                type: 'POST',
                success: function(res) {
                    var result = JSON.parse(res);
                    if (result.status == 'OK') {
...
$(function(){
    $('#the-tv-node').contextMenu({
        ...
        callback: function(key, options) {
            var m = "clicked: " + key + " on " + $(this).attr('data-id');
        $.ajax({
                url: '/user/user_media_tv_status/' + $(this).attr('data-id') + '/' + key,
                type: 'POST',
                success: function(res) {
                    var result = JSON.parse(res);
                    if (result.status == 'OK') {
...
$(function(){
    $('#the-tv-metadata-node').contextMenu({
        ...
        callback: function(key, options) {
            var m = "clicked: " + key + " on " + $(this).attr('data-id');
        $.ajax({
                url: '/user/user_metadata_tv_status/' + $(this).attr('data-id') + '/' + key,
                type: 'POST',
                success: function(res) {
                    var result = JSON.parse(res);
                    if (result.status == 'OK') {
