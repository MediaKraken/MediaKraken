...
pub async fn user_metadata_game(sqlx_pool: &rocket::State<sqlx::PgPool>, page: i8) -> Template {
...
pub async fn user_metadata_game_detail(sqlx_pool: &rocket::State<sqlx::PgPool>, guid: String) -> Template {
