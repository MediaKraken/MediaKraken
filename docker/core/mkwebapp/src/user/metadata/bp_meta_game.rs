...
pub async fn user_metadata_game_detail(sqlx_pool: &rocket::State<sqlx::PgPool>, user: User, guid: Uuid) -> Template {
    Template::render("bss_user/metadata/bss_user_metadata_game_detail", {})
}
