...
pub async fn user_metadata_sports(sqlx_pool: &rocket::State<sqlx::PgPool>, page: i8) -> Template {
...
pub async fn user_metadata_sports_detail(sqlx_pool: &rocket::State<sqlx::PgPool>, guid: String) -> Template {
