...
pub async fn user_media_movie(sqlx_pool: &rocket::State<sqlx::PgPool>, page: i8) -> Template {
    ...
    Template::render("bss_user/media/bss_user_media_movie", context! {
...
pub async fn user_media_movie_detail(sqlx_pool: &rocket::State<sqlx::PgPool>, guid: String) -> Template {
