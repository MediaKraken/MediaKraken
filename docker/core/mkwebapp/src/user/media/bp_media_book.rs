...
#[get("/media/book/<page>")]
pub async fn user_media_book(sqlx_pool: &rocket::State<sqlx::PgPool>, page: i8) -> Template {
...
pub async fn user_media_book_detail(sqlx_pool: &rocket::State<sqlx::PgPool>, guid: String) -> Template {
