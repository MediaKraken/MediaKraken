...
mod database::mk_lib_database_media_book;
...
pub async fn user_media_book(
    ...
    let total_pages: i64 =
        database::mk_lib_database_media_book::mk_lib_database_media_book_count(&sqlx_pool, String::new())
            .await
            .unwrap();
    ...
    .await
    .unwrap();
    let book_list = database::mk_lib_database_media_book::mk_lib_database_media_book_read(
        &sqlx_pool,
        String::new(),
        db_offset,
        30,
    ...
    .unwrap();
    Template::render(
        "bss_user/media/bss_user_media_book",
        &TemplateMediaBookContext {
...
pub async fn user_media_book_detail(
    ...
    Template::render(
        "bss_user/media/bss_user_media_book_detail",
