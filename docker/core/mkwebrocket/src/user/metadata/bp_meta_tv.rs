...
mod database::mk_lib_database_metadata_tv;
...
pub async fn user_metadata_tv(
    ...
    let total_pages: i64 =
        database::mk_lib_database_metadata_tv::mk_lib_database_metadata_tv_count(&sqlx_pool, String::new())
            .await
            .unwrap();
    ...
    .await
    .unwrap();
    let tv_list = database::mk_lib_database_metadata_tv::mk_lib_database_metadata_tv_read(
        &sqlx_pool,
        String::new(),
        db_offset,
        30,
    ...
    .unwrap();
    Template::render(
        "bss_user/metadata/bss_user_metadata_tv",
...
pub async fn user_metadata_tv_detail(
    ...
    Template::render(
        "bss_user/metadata/bss_user_metadata_tv_detail",
