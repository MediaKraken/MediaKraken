...
virt-customize -a debian-12-genericcloud-amd64-20240717-1811.qcow2 --install qemu-guest-agent
...
qm create 9003 --name "debian-12-cloudinit-template-mk" --memory 2048 --cores 2 --net0 virtio,bridge=vmbr0 \
&& qm importdisk 9003 debian-12-genericcloud-amd64-20240717-1811.qcow2 local-lvm \
